...
<section>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        <div>
            ...
            <x-form.text-input wire:model="current_password" id="current_password" name="current_password"
                               type="password"
        ...
        <div>
            ...
            <x-form.text-input wire:model="password" id="password" name="password" type="password"
        ...
        <div>
            ...
            <x-form.text-input wire:model="password_confirmation" id="password_confirmation"
